...
| 푼     | 부품찾기<br/>떡볶이만들기                                   | 1로만들기<br/>정수삼각형<br/>금광          | 순차탐색 다익스트라<br>개선된 다익스트라<br>플로이드워셜<br/>전보<br/>미래도시 |                                                         |
| 어려운 |                                                              | 퇴사<br/>병사배치하기                        |                                                       |                                             |
...
|        | 푼                                                           | 어려운 |
| ------ | ------------------------------------------------------------ | ------ |
| dfsbfs | [1260]dfsbfs<br>[2178]미로탈출<br>[1697]숨바꼭질<br>[2667]단지번호붙이기<br>[1012]유기농배추<br>[11724]연결요소의개수<br>[6603]로또 |        |
|        |                                                              |        |
|        |                                                              |        |
